...
|          |          |          |                                                        |            |             |        |        |        |        |        |        |
|  L CTRL  |  L GUI   |  L ALT   |                      SPACE                             |  FUNCTION  |    R CTRL   |  LEFT  |  DOWN  | RIGHT  |   0    |   .    |        |
...
[_BASE] = LAYOUT_ansi(
    ...
    KC_LCTL, WIN_KEY, KC_LALT,                            KC_SPC,                             FUN_LAY, KS_RCTL, XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT, KC_P0,   KC_PDOT, KC_PENT),
